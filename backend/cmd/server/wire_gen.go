...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	stickySessionCleaner := repository.NewStickySessionCleaner(redisClient)
	accountRepository := repository.NewAccountRepository(client, db, schedulerCache, stickySessionCleaner)
